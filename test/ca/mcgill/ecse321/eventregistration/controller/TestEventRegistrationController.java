...
public class TestEventRegistrationController {
	...
	@Test
	public void testCreatePartcicpantEmpty(){
		RegistrationManager rm = RegistrationManager.getInstance();
		assertEquals(0, rm.getParticipants().size());
	...
	public void testCreateEvent(){
		...
		erc.createEvent(name, eventDate, startTime, endTime);
			...
			//check thatno error occured
			fail();
		}
		
		//check modell in memory
	...
	public void testCreateEmpty(){
		...
		Date eventDate = new Date(c.getTimeInMillis());
		Time startTime = new Time(c.getTimeInMillis());
		c.set(2106, Calendar.OCTOBER,16,10,30,0);
		Time endTime = new Time(c.getTimeInMillis());
	...
	@Test 
	public void testRegisterParticicoantAndEventDoNotExist(){
